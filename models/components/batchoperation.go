...
const (
	QueryTypeMapOfany QueryType = "mapOfany"
...
func CreateQueryMapOfany(mapOfany map[string]interface{}) Query {
	typ := QueryTypeMapOfany
...
func CreateQueryStr(str string) Query {
	typ := QueryTypeStr
...
func (o *BatchOperation) GetQuery() *Query {
	if o == nil {
		return nil
	}
	return o.Query
