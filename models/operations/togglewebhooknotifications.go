...
type ToggleWebhookNotificationsRequestBody struct {
	...
	Topics []components.TopicsValue `json:"topics,omitempty"`
}
...
func (o *ToggleWebhookNotificationsRequestBody) GetTopics() []components.TopicsValue {
	if o == nil {
		return nil
	}
	return o.Topics
...
type ToggleWebhookNotificationsResponse struct {
	...
	ToggleWebhookNotifications *components.ToggleWebhookNotifications
}
...
func (o *ToggleWebhookNotificationsResponse) GetToggleWebhookNotifications() *components.ToggleWebhookNotifications {
	if o == nil {
		return nil
	}
