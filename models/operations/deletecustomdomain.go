...
type DeleteCustomDomainResponse struct {
	...
	DeleteCustomDomainSchema *components.DeleteCustomDomainSchema
...
func (o *DeleteCustomDomainResponse) GetDeleteCustomDomainSchema() *components.DeleteCustomDomainSchema {
	if o == nil {
		return nil
	}
