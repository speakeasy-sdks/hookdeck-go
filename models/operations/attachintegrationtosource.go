...
type AttachIntegrationToSourceResponse struct {
	...
	AttachedIntegrationToSource *components.AttachedIntegrationToSource
...
func (o *AttachIntegrationToSourceResponse) GetAttachedIntegrationToSource() *components.AttachedIntegrationToSource {
	if o == nil {
		return nil
	}
