...
type DetachIntegrationToSourceResponse struct {
	...
	DetachedIntegrationFromSource *components.DetachedIntegrationFromSource
...
func (o *DetachIntegrationToSourceResponse) GetDetachedIntegrationFromSource() *components.DetachedIntegrationFromSource {
	if o == nil {
		return nil
	}
