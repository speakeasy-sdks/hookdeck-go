...
func main() {
    ...
    res, err := s.IssueTrigger.Create(ctx, operations.CreateIssueTriggerRequestBody{
        ...
        Name: hookdeck.String("Melba Toy"),
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.IssueTrigger.Delete(ctx, "facilis")
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.IssueTrigger.Disable(ctx, "in")
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.IssueTrigger.Enable(ctx, "architecto")
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.IssueTrigger.Get(ctx, "architecto")
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.IssueTrigger.Update(ctx, operations.UpdateIssueTriggerRequestBody{
        ...
        DisabledAt: types.MustTimeFromString("2022-01-01T10:06:00.916Z"),
        Name: hookdeck.String("Louis Turner Sr."),
    }, "praesentium")
    if err != nil {
        log.Fatal(err)
    }
