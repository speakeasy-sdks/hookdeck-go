...
func newRequestEvents(sdkConfig sdkConfiguration) *RequestEvents {
...
func (s *RequestEvents) Get(ctx context.Context, request operations.GetRequestEventsRequest) (*operations.GetRequestEventsResponse, error) {
	hookCtx := hooks.HookContext{OperationID: "getRequestEvents"}

	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/requests/{id}/events", request, nil)
	if err != nil {
