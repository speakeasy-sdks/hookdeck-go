...
// Get integrations
func (s *Integrations) Get(ctx context.Context, label *string, provider *components.IntegrationProvider) (*operations.GetIntegrationsResponse, error) {
	hookCtx := hooks.HookContext{OperationID: "getIntegrations"}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(contentType, `application/json`):
			var out components.IntegrationPaginatedResult
