...
func newIssuesCount(sdkConfig sdkConfiguration) *IssuesCount {
	return &IssuesCount{
...
func (s *IssuesCount) Get(ctx context.Context, request operations.GetIssueCountRequest) (*operations.GetIssueCountResponse, error) {
	hookCtx := hooks.HookContext{OperationID: "getIssueCount"}

	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := url.JoinPath(baseURL, "/issues/count")
	if err != nil {
