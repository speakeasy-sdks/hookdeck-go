...
func (s *destinations) ArchiveDestination(ctx context.Context, request operations.ArchiveDestinationRequest) (*operations.ArchiveDestinationResponse, error) {
...
func (s *destinations) CreateDestination(ctx context.Context, request operations.CreateDestinationRequestBody) (*operations.CreateDestinationResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
...
func (s *destinations) UnarchiveDestination(ctx context.Context, request operations.UnarchiveDestinationRequest) (*operations.UnarchiveDestinationResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
...
func (s *destinations) UpsertDestination(ctx context.Context, request operations.UpsertDestinationRequestBody) (*operations.UpsertDestinationResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url := strings.TrimSuffix(baseURL, "/") + "/destinations"
