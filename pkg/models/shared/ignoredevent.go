...
func (i IgnoredEventMetaTransformationFailedMeta) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(i, "", false)
}

func (i *IgnoredEventMetaTransformationFailedMeta) UnmarshalJSON(data []byte) error {
...
func (o *IgnoredEventMetaTransformationFailedMeta) GetAdditionalProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
...
func (o *IgnoredEvent) GetAdditionalProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
	return o.AdditionalProperties
