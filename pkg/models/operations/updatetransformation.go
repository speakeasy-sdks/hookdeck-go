...
func (u UpdateTransformationRequestBody) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(u, "", false)
}

func (u *UpdateTransformationRequestBody) UnmarshalJSON(data []byte) error {
...
func (o *UpdateTransformationRequestBody) GetAdditionalProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
