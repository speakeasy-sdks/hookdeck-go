...
func (g GetEventsAttempts2) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetEventsAttempts2) UnmarshalJSON(data []byte) error {
...
func (o *GetEventsAttempts2) GetAdditionalProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
...
const (
	...
	GetEventsBodyTypeMapOfany GetEventsBodyType = "mapOfany"
)
...
func CreateGetEventsBodyMapOfany(mapOfany map[string]interface{}) GetEventsBody {
	typ := GetEventsBodyTypeMapOfany
...
func (u *GetEventsBody) UnmarshalJSON(data []byte) error {
	...
	if err := utils.UnmarshalJSON(data, &mapOfany, "", true, true); err == nil {
		u.MapOfany = mapOfany
		u.Type = GetEventsBodyTypeMapOfany
		return nil
	}
...
func (g GetEventsCliID2) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetEventsCliID2) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &g, "", false, true); err != nil {
		return err
	}
	return nil
...
func (o *GetEventsCliID2) GetAdditionalProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
	return o.AdditionalProperties
...
func (o *GetEventsCreatedAt2) GetAdditionalProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
	return o.AdditionalProperties
...
const (
	...
	GetEventsHeadersTypeMapOfany GetEventsHeadersType = "mapOfany"
)
...
func CreateGetEventsHeadersMapOfany(mapOfany map[string]interface{}) GetEventsHeaders {
	typ := GetEventsHeadersTypeMapOfany
...
func (u *GetEventsHeaders) UnmarshalJSON(data []byte) error {
	...
	if err := utils.UnmarshalJSON(data, &mapOfany, "", true, true); err == nil {
		u.MapOfany = mapOfany
		u.Type = GetEventsHeadersTypeMapOfany
		return nil
	}
...
func (o *GetEventsLastAttemptAt2) GetAdditionalProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
	return o.AdditionalProperties
...
const (
	...
	GetEventsParsedQueryTypeMapOfany GetEventsParsedQueryType = "mapOfany"
)
...
func CreateGetEventsParsedQueryMapOfany(mapOfany map[string]interface{}) GetEventsParsedQuery {
	typ := GetEventsParsedQueryTypeMapOfany
...
func (u *GetEventsParsedQuery) UnmarshalJSON(data []byte) error {
	...
	if err := utils.UnmarshalJSON(data, &mapOfany, "", true, true); err == nil {
		u.MapOfany = mapOfany
		u.Type = GetEventsParsedQueryTypeMapOfany
		return nil
	}
...
func (g GetEventsResponseStatus2) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetEventsResponseStatus2) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &g, "", false, true); err != nil {
		return err
	}
	return nil
...
func (o *GetEventsResponseStatus2) GetAdditionalProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
	return o.AdditionalProperties
...
func (o *GetEventsSuccessfulAt2) GetAdditionalProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
	return o.AdditionalProperties
