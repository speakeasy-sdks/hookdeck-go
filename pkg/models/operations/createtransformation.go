...
func (c CreateTransformationRequestBody) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(c, "", false)
}

func (c *CreateTransformationRequestBody) UnmarshalJSON(data []byte) error {
...
func (o *CreateTransformationRequestBody) GetAdditionalProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
