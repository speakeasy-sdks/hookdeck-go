...
func (c CreateIssueTriggerRequestBody) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(c, "", false)
}

func (c *CreateIssueTriggerRequestBody) UnmarshalJSON(data []byte) error {
...
func (o *CreateIssueTriggerRequestBody) GetAdditionalProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
