...
const (
	GetIgnoredEventBulkRetriesOrderByTypeStr        GetIgnoredEventBulkRetriesOrderByType = "str"
	GetIgnoredEventBulkRetriesOrderByTypeArrayOfstr GetIgnoredEventBulkRetriesOrderByType = "arrayOfstr"
)
...
func CreateGetIgnoredEventBulkRetriesOrderByStr(str string) GetIgnoredEventBulkRetriesOrderBy {
	typ := GetIgnoredEventBulkRetriesOrderByTypeStr
...
func CreateGetIgnoredEventBulkRetriesOrderByArrayOfstr(arrayOfstr []string) GetIgnoredEventBulkRetriesOrderBy {
	typ := GetIgnoredEventBulkRetriesOrderByTypeArrayOfstr
...
func (u *GetIgnoredEventBulkRetriesOrderBy) UnmarshalJSON(data []byte) error {
	...
	if err := utils.UnmarshalJSON(data, &str, "", true, true); err == nil {
		u.Str = str
		u.Type = GetIgnoredEventBulkRetriesOrderByTypeStr
		return nil
	}
	...
	if err := utils.UnmarshalJSON(data, &arrayOfstr, "", true, true); err == nil {
		u.ArrayOfstr = arrayOfstr
		u.Type = GetIgnoredEventBulkRetriesOrderByTypeArrayOfstr
		return nil
	}
