...
func (o *GetIgnoredEventBulkRetriesCancelledAt2) GetAdditionalProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
...
func (o *GetIgnoredEventBulkRetriesCompletedAt2) GetAdditionalProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
	return o.AdditionalProperties
...
func (o *GetIgnoredEventBulkRetriesCreatedAt2) GetAdditionalProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
	return o.AdditionalProperties
...
func (g GetIgnoredEventBulkRetriesQuery) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetIgnoredEventBulkRetriesQuery) UnmarshalJSON(data []byte) error {
...
func (o *GetIgnoredEventBulkRetriesQuery) GetAdditionalProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
	return o.AdditionalProperties
