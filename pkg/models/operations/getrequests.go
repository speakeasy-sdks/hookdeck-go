...
func (u *GetRequestsRejectionCause) UnmarshalJSON(data []byte) error {
	...
	if err := utils.UnmarshalJSON(data, &requestRejectionCause, "", true, true); err == nil {
...
func (u GetRequestsRejectionCause) MarshalJSON() ([]byte, error) {
	if u.RequestRejectionCause != nil {
		return utils.MarshalJSON(u.RequestRejectionCause, "", true)
	}
...
type GetRequestsRequest struct {
	...
	include        *string                    `const:"data" queryParam:"style=form,explode=true,name=include"`
...
func (g GetRequestsRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetRequestsRequest) UnmarshalJSON(data []byte) error {
...
func (o *GetRequestsRequest) GetInclude() *string {
