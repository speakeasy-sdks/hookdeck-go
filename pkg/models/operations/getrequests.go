...
const (
	...
	GetRequestsBodyTypeMapOfany GetRequestsBodyType = "mapOfany"
)
...
func CreateGetRequestsBodyMapOfany(mapOfany map[string]interface{}) GetRequestsBody {
	typ := GetRequestsBodyTypeMapOfany
...
func (u *GetRequestsBody) UnmarshalJSON(data []byte) error {
	...
	if err := utils.UnmarshalJSON(data, &mapOfany, "", true, true); err == nil {
		u.MapOfany = mapOfany
		u.Type = GetRequestsBodyTypeMapOfany
		return nil
	}
...
func (o *GetRequestsCreatedAt2) GetAdditionalProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
...
func (g GetRequestsEventsCount2) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetRequestsEventsCount2) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &g, "", false, true); err != nil {
		return err
	}
	return nil
...
func (o *GetRequestsEventsCount2) GetAdditionalProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
	return o.AdditionalProperties
...
const (
	...
	GetRequestsHeadersTypeMapOfany GetRequestsHeadersType = "mapOfany"
)
...
func CreateGetRequestsHeadersMapOfany(mapOfany map[string]interface{}) GetRequestsHeaders {
	typ := GetRequestsHeadersTypeMapOfany
...
func (u *GetRequestsHeaders) UnmarshalJSON(data []byte) error {
	...
	if err := utils.UnmarshalJSON(data, &mapOfany, "", true, true); err == nil {
		u.MapOfany = mapOfany
		u.Type = GetRequestsHeadersTypeMapOfany
		return nil
	}
...
func (g GetRequestsIgnoredCount2) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetRequestsIgnoredCount2) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &g, "", false, true); err != nil {
		return err
	}
	return nil
...
func (o *GetRequestsIgnoredCount2) GetAdditionalProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
	return o.AdditionalProperties
...
func (o *GetRequestsIngestedAt2) GetAdditionalProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
	return o.AdditionalProperties
...
const (
	...
	GetRequestsParsedQueryTypeMapOfany GetRequestsParsedQueryType = "mapOfany"
)
...
func CreateGetRequestsParsedQueryMapOfany(mapOfany map[string]interface{}) GetRequestsParsedQuery {
	typ := GetRequestsParsedQueryTypeMapOfany
...
func (u *GetRequestsParsedQuery) UnmarshalJSON(data []byte) error {
	...
	if err := utils.UnmarshalJSON(data, &mapOfany, "", true, true); err == nil {
		u.MapOfany = mapOfany
		u.Type = GetRequestsParsedQueryTypeMapOfany
		return nil
	}
...
func (g GetRequestsRejectionCause2) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetRequestsRejectionCause2) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &g, "", false, true); err != nil {
		return err
	}
	return nil
...
func (o *GetRequestsRejectionCause2) GetAdditionalProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
	return o.AdditionalProperties
