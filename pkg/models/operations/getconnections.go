...
func (o *GetConnectionsArchivedAt2) GetAdditionalProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
...
func (g GetConnectionsName2) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetConnectionsName2) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &g, "", false, true); err != nil {
		return err
	}
	return nil
...
func (o *GetConnectionsName2) GetAdditionalProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
	return o.AdditionalProperties
...
func (o *GetConnectionsPausedAt2) GetAdditionalProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
	return o.AdditionalProperties
