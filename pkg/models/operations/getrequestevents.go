...
func (g GetRequestEventsRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetRequestEventsRequest) UnmarshalJSON(data []byte) error {
...
func (o *GetRequestEventsRequest) GetInclude() *string {
