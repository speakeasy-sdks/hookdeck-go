...
func (s *bulkRetryRequests) CancelRequestBulkRetry(ctx context.Context, request operations.CancelRequestBulkRetryRequest) (*operations.CancelRequestBulkRetryResponse, error) {
...
func (s *bulkRetryRequests) GetRequestBulkRetry(ctx context.Context, request operations.GetRequestBulkRetryRequest) (*operations.GetRequestBulkRetryResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
