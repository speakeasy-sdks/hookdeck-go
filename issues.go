...
// Get issues
func (s *Issues) Get(ctx context.Context, request operations.GetIssuesRequest) (*operations.GetIssuesResponse, error) {
	hookCtx := hooks.HookContext{OperationID: "getIssues"}

	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := url.JoinPath(baseURL, "/issues")
	if err != nil {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(contentType, `application/json`):
			var out components.IssueWithDataPaginatedResult
