...
func (s *bookmarks) CreateBookmark(ctx context.Context, request operations.CreateBookmarkRequestBody) (*operations.CreateBookmarkResponse, error) {
...
func (s *bookmarks) DeleteBookmark(ctx context.Context, request operations.DeleteBookmarkRequest) (*operations.DeleteBookmarkResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
...
func (s *bookmarks) GetBookmark(ctx context.Context, request operations.GetBookmarkRequest) (*operations.GetBookmarkResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url, err := utils.GenerateURL(ctx, baseURL, "/bookmarks/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
...
func (s *bookmarks) TriggerBookmark(ctx context.Context, request operations.TriggerBookmarkRequest) (*operations.TriggerBookmarkResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
...
func (s *bookmarks) UpdateBookmark(ctx context.Context, request operations.UpdateBookmarkRequest) (*operations.UpdateBookmarkResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url, err := utils.GenerateURL(ctx, baseURL, "/bookmarks/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
