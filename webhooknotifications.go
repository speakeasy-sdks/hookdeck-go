...
func (s *WebhookNotifications) Toggle(ctx context.Context, request operations.ToggleWebhookNotificationsRequestBody) (*operations.ToggleWebhookNotificationsResponse, error) {
	hookCtx := hooks.HookContext{OperationID: "toggleWebhookNotifications"}

	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := url.JoinPath(baseURL, "/notifications/webhooks")
	if err != nil {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(contentType, `application/json`):
			var out components.ToggleWebhookNotifications
